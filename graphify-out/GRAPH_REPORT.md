...
## Corpus Check
- 16357 files · ~11,230,756 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 17018 nodes · 18575 edges · 7022 communities (5947 shown, 1075 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 7 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bbb5c7e6`
...
- `FeedbackScreen()` --calls--> `useAppStore`  [EXTRACTED]
  app/(tabs)/speak/feedback.tsx → src/store/useAppStore.ts
- `ProfileScreen()` --calls--> `useAppStore`  [EXTRACTED]
  app/(tabs)/profile/index.tsx → src/store/useAppStore.ts
...
Cohesion: 0.04
Nodes (58): access, app, audioDebug, clampRawText(), coach, coachReplyJsonSchema, context, conversationText (+50 more)

### Community 6 - "Community 6"
Cohesion: 0.05
Nodes (43): styles, CoachAvatar(), CoachAvatarProps, sprite, stateIndex, statusLabel, styles, FeedbackSummary() (+35 more)
...
Cohesion: 0.06
Nodes (43): Index(), MeaningPanel(), MeaningPanelProps, styles, PrimaryActionButton(), PrimaryActionButtonProps, styles, Screen() (+35 more)
...
Cohesion: 0.08
Nodes (53): getAdaptiveLessonRecommendation(), getLearnerPracticePlan(), PracticeFocus, GoalProgress(), GoalProgressProps, styles, StreakProgress(), StreakProgressProps (+45 more)
...
Cohesion: 0.07
Nodes (52): AuthSession, createDevSession(), getAuthEndpoint(), getCurrentSession(), assertExportedSyncHelpers(), authProfile, authSessions, AppState (+44 more)
...
Cohesion: 0.08
Nodes (42): ConversationBubble(), ConversationBubbleProps, getModelSentence(), getVerdictLabel(), normalizeSpeechText(), styles, checkLessonPronunciation(), checkPracticeConnection() (+34 more)
...
Cohesion: 0.23
Nodes (29): applyCommonGrammarFixes(), buildGrammarCorrection(), buildLocalFeedback(), cleanFeedbackLists(), cleanSentence(), extractQuotedSentences(), getAverageScore(), getCoachSuggestedSentence() (+21 more)
...
Cohesion: 0.15
Nodes (23): asStringArray(), clampText(), ensureRetryReplyNarratesSentence(), extractJsonObject(), formatPronunciationContext(), getCoachReplyFromAssessment(), getFirstSupportSentence(), getOptionalScore() (+15 more)
...
Cohesion: 0.16
Nodes (15): arraysHaveSameCounts(), fs, isNonEmptyString(), labelActivity(), labelLesson(), Module, path, repoRoot (+7 more)
...
Cohesion: 0.21
Nodes (12): canConvertAudioForAssessment(), convertAudioForAssessment(), createAudioPronunciationAssessment(), createCoachAudioUrl(), createCoachReply(), formatConversationTurns(), getAudioAssessmentFormat(), getAudioFileDebugInfo() (+4 more)
...
Cohesion: 0.33
Nodes (5): [English_Learning_App_Codex] recent context, 2026-06-12 5:44pm EDT, graphify, Jun 6, 2026, May 3, 2026, Memory Context
...
## Knowledge Gaps
- **477 isolated node(s):** `styles`, `styles`, `styles`, `orderedLessonIds`, `PronunciationStatus` (+472 more)
...
- **Why does `main()` connect `Community 97` to `Community 105`, `Community 106`, `Community 42`?**
  _High betweenness centrality (0.000) - this node is a cross-community bridge._
- **Why does `createRealtimeSessionConfig()` connect `Community 21` to `Community 5`?**
  _High betweenness centrality (0.000) - this node is a cross-community bridge._
- **Why does `modules` connect `Community 11` to `Community 64`, `Community 105`, `Community 106`, `Community 13`?**
  _High betweenness centrality (0.000) - this node is a cross-community bridge._
