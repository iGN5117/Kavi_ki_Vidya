# Graph Report - English_Learning_App_Codex  (2026-07-06)

## Corpus Check
- 16371 files · ~11,284,601 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 17274 nodes · 19141 edges · 7022 communities (5947 shown, 1075 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 9 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `60de1032`
...
- `LessonScreen()` --calls--> `usePlayableAudio()`  [EXTRACTED]
  app/(tabs)/learn/lesson/[lessonId].tsx → src/hooks/usePlayableAudio.ts
- `LessonScreen()` --calls--> `useAppStore`  [EXTRACTED]
  app/(tabs)/learn/lesson/[lessonId].tsx → src/store/useAppStore.ts

## Communities (7022 total, 1075 thin omitted)
...
Cohesion: 0.03
Nodes (141): access, app, applyCommonLocalGrammarFixes(), asStringArray(), audioDebug, buildLocalGrammarCorrection(), canConvertAudioForAssessment(), clampNumber() (+133 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (106): getAdaptiveLessonRecommendation(), getLearnerPracticePlan(), PracticeFocus, Index(), styles, CoachAvatar(), CoachAvatarProps, sprite (+98 more)
...
Cohesion: 0.07
Nodes (57): AuthSession, createDevSession(), getAuthEndpoint(), getCurrentSession(), assertExportedSyncHelpers(), loadTsModule(), authProfile, authSessions (+49 more)
...
Cohesion: 0.07
Nodes (43): PlayableAudioOptions, usePlayableAudio(), LearnLayout(), getTabBarStyle(), checkLessonPronunciation(), checkPracticeConnection(), CoachTurnResult, createLessonAudio() (+35 more)
...
Cohesion: 0.11
Nodes (49): FeedbackSummary(), FeedbackSummaryProps, styles, applyCommonGrammarFixes(), buildGrammarCorrection(), buildLocalFeedback(), cleanFeedbackLists(), cleanSentence() (+41 more)
...
Cohesion: 0.22
Nodes (36): stringify(), assert(), requestJson(), assert(), assertBilingualSupport(), assertDoesNotCreateSelfGreetingDrill(), assertDoesNotMention(), assertDoesNotRepeatHighScoredSentence() (+28 more)
...
Cohesion: 0.16
Nodes (21): assert(), assertDateKey(), assertIsoString(), assertNoDuplicates(), assertSnapshotVerifierCatchesPersistenceRisks(), assertStaticStoreContract(), extractFunctionBody(), extractTypeBody() (+13 more)

### Community 72 - "Community 72"
Cohesion: 0.12
Nodes (21): arraysHaveSameCounts(), fs, isNonEmptyString(), labelActivity(), labelLesson(), Module, path, sortedCounts() (+13 more)
...
Cohesion: 0.27
Nodes (22): [English_Learning_App_Codex] recent context, 2026-06-12 5:44pm EDT, [English_Learning_App_Codex] recent context, 2026-06-12 6:55pm EDT, [English_Learning_App_Codex] recent context, 2026-06-13 10:16am EDT, [English_Learning_App_Codex] recent context, 2026-06-13 10:50am EDT, [English_Learning_App_Codex] recent context, 2026-06-13 3:19pm EDT, [English_Learning_App_Codex] recent context, 2026-06-13 3:43pm EDT, [English_Learning_App_Codex] recent context, 2026-06-13 3:45pm EDT, [English_Learning_App_Codex] recent context, 2026-06-13 3:53pm EDT (+14 more)
...
Cohesion: 0.16
Nodes (17): assert(), assertUsefulPracticeHref(), fs, getLessonModuleById(), getLessonSkillTagsById(), loadTsModule(), makeFeedback(), makePlanInput() (+9 more)
...
## Knowledge Gaps
- **560 isolated node(s):** `styles`, `styles`, `styles`, `orderedLessonIds`, `PronunciationStatus` (+555 more)
...
- **Why does `run()` connect `Community 96` to `Community 3`, `Community 4`, `Community 71`, `Community 39`, `Community 13`, `Community 61`?**
  _High betweenness centrality (0.000) - this node is a cross-community bridge._
- **Why does `personalizeFeedbackWithTurnPronunciation()` connect `Community 21` to `Community 17`, `Community 2`?**
  _High betweenness centrality (0.000) - this node is a cross-community bridge._
- **Why does `getLearnerPracticePlan()` connect `Community 3` to `Community 96`, `Community 73`, `Community 21`?**
  _High betweenness centrality (0.000) - this node is a cross-community bridge._
