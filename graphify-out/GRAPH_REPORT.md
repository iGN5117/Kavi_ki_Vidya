...
## Corpus Check
- 16373 files · ~11,286,211 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 17306 nodes · 19242 edges · 7024 communities (5949 shown, 1075 thin omitted)
...
5. `run()` - 25 edges
6. `radii` - 25 edges
7. `KaviLiveAudio` - 24 edges
8. `styles` - 23 edges
9. `clampText()` - 23 edges
...
## Communities (7024 total, 1075 thin omitted)
...
Cohesion: 0.02
Nodes (144): access, app, applyCommonLocalGrammarFixes(), asStringArray(), audioDebug, buildLocalGrammarCorrection(), canConvertAudioForAssessment(), clampNumber() (+136 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (107): getAdaptiveLessonRecommendation(), getLearnerPracticePlan(), PracticeFocus, Index(), styles, CoachAvatar(), CoachAvatarProps, sprite (+99 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (62): ConversationBubble(), ConversationBubbleProps, getFocusItems(), getModelSentence(), getVerdictLabel(), normalizeSpeechText(), styles, MeaningPanel() (+54 more)
...
Cohesion: 0.08
Nodes (40): PlayableAudioOptions, usePlayableAudio(), checkLessonPronunciation(), checkPracticeConnection(), CoachTurnResult, createLessonAudio(), createRealtimeSession(), generateSessionFeedback() (+32 more)
...
Cohesion: 0.08
Nodes (28): addLivePcmAudioChunkListener(), addLivePcmAudioErrorListener(), addLivePcmAudioStateListener(), clearLivePcmAudioPlayback(), isLivePcmAudioAvailable(), AudioChunkEvent, ErrorEvent, KaviLiveAudioNativeModule (+20 more)
...
Cohesion: 0.22
Nodes (27): [English_Learning_App_Codex] recent context, 2026-06-12 5:44pm EDT, [English_Learning_App_Codex] recent context, 2026-06-12 6:55pm EDT, [English_Learning_App_Codex] recent context, 2026-06-13 10:16am EDT, [English_Learning_App_Codex] recent context, 2026-06-13 10:50am EDT, [English_Learning_App_Codex] recent context, 2026-06-13 3:19pm EDT, [English_Learning_App_Codex] recent context, 2026-06-13 3:43pm EDT, [English_Learning_App_Codex] recent context, 2026-06-13 3:45pm EDT, [English_Learning_App_Codex] recent context, 2026-06-13 3:53pm EDT (+19 more)
...
Cohesion: 0.15
Nodes (23): assert(), assertDateKey(), assertExportedSyncHelpers(), assertIsoString(), assertNoDuplicates(), assertSnapshotVerifierCatchesPersistenceRisks(), assertStaticStoreContract(), extractFunctionBody() (+15 more)
...
Cohesion: 0.18
Nodes (17): bundledCurriculum, CurriculumLoadResult, CurriculumSource, fetchBackendCurriculum(), getBundledCurriculum(), getCurriculumEndpoint(), hasCurriculumEndpoint(), isPlainObject() (+9 more)
...
Cohesion: 0.19
Nodes (15): getLessonSkillTags(), assert(), assertUsefulPracticeHref(), fs, getLessonModuleById(), getLessonSkillTagsById(), loadTsModule(), makeFeedback() (+7 more)
...
- **Why does `sampleFeedback` connect `Community 21` to `Community 3`, `Community 4`, `Community 23`?**
  _High betweenness centrality (0.000) - this node is a cross-community bridge._
- **Why does `run()` connect `Community 110` to `Community 64`, `Community 3`, `Community 60`, `Community 39`?**
  _High betweenness centrality (0.000) - this node is a cross-community bridge._
- **Why does `modules` connect `Community 3` to `Community 64`, `Community 4`, `Community 110`, `Community 91`, `Community 63`?**
  _High betweenness centrality (0.000) - this node is a cross-community bridge._
